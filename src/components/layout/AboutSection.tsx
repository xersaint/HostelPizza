  ...
  return (
    <section id="about" className={className}>
      <div className='grid grid-cols-2'>
        ...
        <div className="p-24">
          <h1 className="mb-4">Welcome to <span className=" text-primary">Hostel Pizza Ordering</span></h1>
          <div className='text-gray-300'>
            <p className='mb-4'>
              At Hostel Pizza Ordering, our story is a delightful journey of passion and flavor.
